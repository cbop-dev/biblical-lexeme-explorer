...
<div class="block items-center">
	...
	<LexFilterInput
		...
		tooltip="Enter (case-sensitive) Latin characters, which will convert automatically to Greek/Hebrew!"
...
<div>
	...
	{:else}
		Type some text above to search for {StringUtils.capitalize(tfData.lang)} words.
	{/if}
</div>
...
<Modal bind:showModal title="Lemma Details">
