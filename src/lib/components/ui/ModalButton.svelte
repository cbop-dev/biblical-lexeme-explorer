<script>
	...
	let { buttonText, title='', description='', header=null, children=null, buttonStyle=null} = $props();
...
<Button {buttonText} buttonStyle={buttonStyle ? buttonStyle : 'btn btn-ghost font-normal'} buttonColors='' toggled={()=>{showModal = true;}} />
